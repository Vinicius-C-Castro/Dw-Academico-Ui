...
const options = {
  ...
  xaxis: {
    ...
    categories: ['Apenas em escola particular', 'A maior parte em escola particular', 'A maior parte em escola pública','Apenas em escola pública'],
  },
  fill: {
    opacity: 0.3,
    type: 'gradient',
...
export default function Escola() {
  ...
  useEffect(() => {
    api.get<Escola[]>('/escola').then(response => {
